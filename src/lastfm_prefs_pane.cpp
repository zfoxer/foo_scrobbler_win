...
static service_factory_single_t<advconfig_entry_string_impl>
    g_tagArtistTf("Artist (Title Formatting)", GUID_LASTFM_PREFS_TF_ARTIST,
...
static service_factory_single_t<advconfig_entry_string_impl>
    g_tagTitleTf("Title (Title Formatting)", GUID_LASTFM_PREFS_TF_TITLE,
                 GUID_LASTFM_PREFS_BRANCH_TAG_FORMATTING, 2.0, "[%TITLE%]", 0);

static service_factory_single_t<advconfig_entry_string_impl>
    g_tagAlbumTf("Album (Title Formatting)", GUID_LASTFM_PREFS_TF_ALBUM,
...
static service_factory_single_t<advconfig_entry_string_impl>
    g_excludeArtists("Exclude artists (text or regex; ';' separated)",
                     GUID_LASTFM_PREFS_EXCLUDE_ARTISTS, GUID_LASTFM_PREFS_BRANCH_SCROBBLING, 2.0, "", 0);

static service_factory_single_t<advconfig_entry_string_impl>
    g_excludeTitles("Exclude titles (text or regex; ';' separated)",
