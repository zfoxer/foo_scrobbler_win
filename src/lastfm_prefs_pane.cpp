...
static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagCheckboxFallback("If selected Artist or Album source is empty, fall back to ARTIST / ALBUM", 
                            GUID_LASTFM_TAG_CHECKBOX_FALLBACK_ARTIST_ALBUM,
...
static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagCheckboxTreatVA("Treat \"Various Artists\" as empty (Album Artist only)",
                         GUID_LASTFM_TAG_CHECKBOX_VA_AS_EMPTY,
                         GUID_LASTFM_PREFS_BRANCH_TAG_FALLBACK_COMP, 1.0, false, false, 0); // default OFF

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagTitleRadio0("TITLE", GUID_LASTFM_TAG_TITLE_RADIO_0,
                     GUID_LASTFM_PREFS_BRANCH_TAG_TITLE, 0.0, true, true, 0); // default ON

static service_factory_single_t<advconfig_entry_checkbox_impl> g_tagTitleRadio1("WORK", 
                                                                                GUID_LASTFM_TAG_TITLE_RADIO_1,
                                                                                GUID_LASTFM_PREFS_BRANCH_TAG_TITLE, 1.0,
                                                                                false, true, 0);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagTitleRadio2("MOVEMENT", GUID_LASTFM_TAG_TITLE_RADIO_2,
                     GUID_LASTFM_PREFS_BRANCH_TAG_TITLE, 2.0, false, true, 0);

static service_factory_single_t<advconfig_entry_checkbox_impl> g_tagTitleRadio3("PART", 
                                                                                GUID_LASTFM_TAG_TITLE_RADIO_3,
                                                                                GUID_LASTFM_PREFS_BRANCH_TAG_TITLE, 3.0,
                                                                                false, true, 0);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagTitleRadio4("SUBTITLE", GUID_LASTFM_TAG_TITLE_RADIO_4,
                     GUID_LASTFM_PREFS_BRANCH_TAG_TITLE, 4.0, false, true, 0);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagAlbumRadio0("ALBUM", GUID_LASTFM_TAG_ALBUM_RADIO_0,
                     GUID_LASTFM_PREFS_BRANCH_TAG_ALBUM, 0.0, true, true, 0); // default ON

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagAlbumRadio1("RELEASE", GUID_LASTFM_TAG_ALBUM_RADIO_1,
                     GUID_LASTFM_PREFS_BRANCH_TAG_ALBUM, 1.0, false, true, 0);

static service_factory_single_t<advconfig_entry_checkbox_impl> g_tagAlbumRadio2("WORK", 
                                                                                GUID_LASTFM_TAG_ALBUM_RADIO_2,
                                                                                GUID_LASTFM_PREFS_BRANCH_TAG_ALBUM, 2.0,
                                                                                false, true, 0);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagAlbumRadio3("ALBUMTITLE", GUID_LASTFM_TAG_ALBUM_RADIO_3,
                     GUID_LASTFM_PREFS_BRANCH_TAG_ALBUM, 3.0, false, true, 0);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagAlbumRadio4("DISCNAME", GUID_LASTFM_TAG_ALBUM_RADIO_4,
...
// Radios
static service_factory_single_t<advconfig_entry_checkbox_impl> g_radio0("None", 
...
static service_factory_single_t<advconfig_entry_checkbox_impl> g_radio1("Basic", 
                                                                        GUID_LASTFM_PREFS_RADIO_1,
                                                                        GUID_LASTFM_PREFS_BRANCH_CONSOLE, 1.0, true,
                                                                        true, 0);

static service_factory_single_t<advconfig_entry_checkbox_impl> g_radio2("Debug", 
...
static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_checkbox0("Disable NowPlaying notifications", 
                GUID_LASTFM_PREFS_CHECKBOX_0, GUID_LASTFM_PREFS_BRANCH_SCROBBLING, 0.0, false, false, 0);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_checkbox1("Only scrobble from media library", 
                GUID_LASTFM_PREFS_CHECKBOX_1, GUID_LASTFM_PREFS_BRANCH_SCROBBLING, 1.0, false, false, 0);

// Dynamic sources (3-choice radio group)
static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_dynamicRadio0("No dynamic sources", GUID_LASTFM_PREFS_DYNAMIC_RADIO_0,
                    GUID_LASTFM_PREFS_BRANCH_DYNAMIC, 0.0, false, true, 0u);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_dynamicRadio1("Only NP notifications", GUID_LASTFM_PREFS_DYNAMIC_RADIO_1,
                    GUID_LASTFM_PREFS_BRANCH_DYNAMIC, 1.0, false, true, 0u);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_dynamicRadio2("NP & Scrobbling", GUID_LASTFM_PREFS_DYNAMIC_RADIO_2,
                    GUID_LASTFM_PREFS_BRANCH_DYNAMIC, 2.0, true, true, 0u);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagArtistRadio0("ARTIST", GUID_LASTFM_TAG_ARTIST_RADIO_0,
                      GUID_LASTFM_PREFS_BRANCH_TAG_ARTIST, 0.0, true, true, 0u); // default ON

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagArtistRadio1("ALBUM ARTIST", GUID_LASTFM_TAG_ARTIST_RADIO_1,
                      GUID_LASTFM_PREFS_BRANCH_TAG_ARTIST, 1.0, false, true, 0u);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagArtistRadio2("PERFORMER", GUID_LASTFM_TAG_ARTIST_RADIO_2,
                      GUID_LASTFM_PREFS_BRANCH_TAG_ARTIST, 2.0, false, true, 0u);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagArtistRadio3("COMPOSER", GUID_LASTFM_TAG_ARTIST_RADIO_3,
                      GUID_LASTFM_PREFS_BRANCH_TAG_ARTIST, 3.0, false, true, 0u);

static service_factory_single_t<advconfig_entry_checkbox_impl>
    g_tagArtistRadio4("CONDUCTOR", GUID_LASTFM_TAG_ARTIST_RADIO_4,
                      GUID_LASTFM_PREFS_BRANCH_TAG_ARTIST, 4.0, false, true, 0u);
